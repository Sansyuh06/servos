...
const PRODUCT_DATA: Record<ProductId, ProductData> = {
  left: {
    ...
    colors: {
      ...
      glow: 'bg-accent',
      ring: 'border-l-accent/50',
    },
    stats: { connectionStatus: 'Analyzing', batteryLevel: 100 },
    features: [
      { label: 'Risk Score', value: 85, icon: Zap },
      { label: 'Integrity', value: 92, icon: Wifi },
    ],
  },
  right: {
    id: 'right',
    ...
    colors: {
      ...
      glow: 'bg-danger',
      ring: 'border-r-danger/50',
    },
    stats: { connectionStatus: 'High Risk', batteryLevel: 100 },
    features: [
      { label: 'Threats', value: 94, icon: Bluetooth },
      { label: 'MFT Scanned', value: 88, icon: Music },
    ],
  },
};
